...
> - Отключили питание 220v перед подключением программатора
> - Для прошивки используете только питание **3.3V** для esp12e
> - Понимаете, что неправильные настройки защиты могут привести к ложным срабатываниям

⚠️**Автор не несёт ответственности за ущерб, причинённый при использовании данной прошивки и рекомендаций изложенных здесь, все что вы делаете только на свой страх и риск.**
